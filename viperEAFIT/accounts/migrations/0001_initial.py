    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('TC', 'Teacher'), ('CO', 'Coordinator'), ('AD', 'Admin')], max_length=15, verbose_name='User Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('NV', 'Novicio'), ('DC', 'Docente'), ('MA', 'Master')], default='NV', max_length=15)),
