...
def lns_test():
      ...
      rnd = lns.gen_rndsol(some_profs, some_clases_index, some_clases)
      for i in range(600):
...
def cross_over(profs, clases_index, clases, parent1, parent2, rate):
    ...
    if roll <= rate:
        ...
        for claseid in clases_index:
            ...
            if index <= co_point:
                ...
                if not p2c1prof.is_avail(clase.horario):
                    child1.del_clprof(clase)
                    child1_holes[clase.iden] = 1
                    p2c1prof = None
                ...
                if not p1c2prof.is_avail(clase.horario):
                    child2.del_clprof(clase)
                    child2_holes[clase.iden] = 1
                    p1c2prof = None
        ...
        lns.do_lns(child1, profs, clases_index, clases, silly_teachers = 30, shook_classes = 30, extra_holes = child1_holes)

        lns.do_lns(child2, profs, clases_index, clases, silly_teachers = 30, shook_classes = 30, extra_holes = child2_holes)
