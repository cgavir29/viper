    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordinator', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='accounts.Coordinator')),
            ],
        ),
        migrations.CreateModel(
            name='SubProgram',
            ...
            options={
                'verbose_name': 'Sub-Programs',
            },
        ),
        migrations.AddField(
            model_name='course',
            name='subprogram',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='academics.SubProgram'),
        ),
        migrations.AddField(
            model_name='course',
            name='teachers',
